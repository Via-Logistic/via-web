<template>
  <div
    class="header header-transparent section-fluid"
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-8 col-md-7 d-none d-md-block">
              ...
              <div class="main-menu-language-wrapper">
                <!-- Main Menu Start -->
                <Navigation addClassName="main-menu-dark" />
                <!-- Main Menu End -->

                <!-- Language Start -->
                <div class="language language-dark d-md-none d-lg-flex">
            ...
            <div class="col-lg-2 col-md-2 col-6">
              ...
              <div
                class="mobile-menu-toggle mobile-menu-toggle--black"
