import { reactive, getCurrentInstance, version, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, h, defineComponent, unref, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-5a028f8c.js").then((m) => m.default || m)
  },
  {
    name: "blog-details",
    path: "/blog-details",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blog-details-ee5fe9d4.js").then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/blog-714e4a80.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-be7002d9.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-58c3b63b.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/project-details-26154a1e.js").then((m) => m.default || m)
  },
  {
    name: "project",
    path: "/project",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/project-dabb4c16.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-cfbcffbd.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-d294f0e2.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-070d36eb.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
