...
import { defineComponent, computed, ref, h, resolveComponent, useSSRContext, mergeProps, withCtx, createVNode, createTextVNode } from 'file:///Users/yakupsari/Documents/Github/check/via-web/node_modules/vue/index.mjs';
...
import { hasProtocol } from 'file:///Users/yakupsari/Documents/Github/check/via-web/node_modules/ufo/dist/index.mjs';
...
const _imports_0$1 = "" + publicAssetsURL("images/logo/logo-white.png");
const _sfc_main$2 = {
  name: "MobileNavMenu",
  mounted() {
...
const _imports_0 = "" + publicAssetsURL("images/logo/logo-black.png");
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li></ul><div class="contact-info">Your address goes here<br> <a href="tel:0123456789">0123456789</a> <br> <a href="mailto:demo@example.com">demo@example.com</a></div><ul class="footer-social-icons social-media-link justify-content-center"><li><a href="#" target="_blank" class="icofont-facebook"></a></li><li><a href="#" target="_blank" class="icofont-twitter"></a></li><li><a href="#" target="_blank" class="icofont-instagram"></a></li><li><a href="#" target="_blank" class="icofont-linkedin"></a></li><li><a href="#" target="_blank" class="icofont-pinterest"></a></li></ul><div class="copyright">\xA9 2023 <span>GOTHIC</span> Made with <i class="icofont-heart-alt text-danger"></i> by <a href="#">HasThemes</a></div></div></div></div></footer>`);
}
...
export { Navigation as N, __nuxt_component_0 as _, __nuxt_component_1 as a, __nuxt_component_4 as b, _imports_0$1 as c, __nuxt_component_1$2 as d, _imports_0 as e };
//# sourceMappingURL=Footer-a4531141.mjs.map
